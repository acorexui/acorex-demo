    ...
    pinned: {
      ...
      items: [
        ...
        },
        {
          ...
          href: '/dashboard',
          index: 2,
          data: { description: 'View your dashboard' },
        },
      ],
    },
    list: {
      ...
      items: [
        ...
        },
        {
          ...
          href: '/profile',
          index: 3,
          data: { description: 'Manage your profile' },
        },
        {
          ...
          href: '/settings',
          index: 4,
          data: { description: 'Configure settings' },
        },
        {
          ...
          href: '/messages',
          index: 5,
          data: { description: 'Check your messages' },
        },
        {
